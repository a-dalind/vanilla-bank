...
export class Store {
	 ...
	 */
	static getInstance() { // статичный метод можно вызвать без создания нового экземляра класса
	...
	removeObserver(observer) {
		this.observers = this.observers.filter(obs => obs !== observer); // если обзервер не равен текущему обзерверу, то удаляем
	}
